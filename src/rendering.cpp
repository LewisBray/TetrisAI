...
static void render_character(Scene& scene, const i8 c, const f32 x, const f32 y) {
    ...
    scene.vertices[scene.vertex_index + 0].colour = WHITE;
    ...
    scene.vertices[scene.vertex_index + 1].colour = WHITE;
    ...
    scene.vertices[scene.vertex_index + 2].colour = WHITE;
    ...
    scene.vertices[scene.vertex_index + 3].colour = WHITE;
